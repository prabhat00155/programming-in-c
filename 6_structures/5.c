/* Program to create a binary search tree and try different tree-traversal
 * techniques to print the values.
 * Author: Prabhat Roy
 */
...
int main()
{
    ...
    inorder(root);
    printf("\n");
    printf("BST nodes (preorder):\n");
    preorder(root);
    printf("\n");
    printf("BST nodes (postorder):\n");
    postorder(root);
    printf("\n");
    remove_all(root);
    return 0;
